...
const items = [
  {
    icon: workflowIcon,
    title: 'Your full Unique workflow',
    description: 'Manage projects, databases, branches, roles, and&nbsp;more.',
    linkText: 'View all Unique CLI commands',
    url: LINKS.cliReference,
  },
  {
    icon: scriptIcon,
    title: 'Script and automate',
    description: 'Use the Unique CLI to script almost any&nbsp;action in&nbsp;Neon.',
  ...
  },
  {
    icon: contributeIcon,
    title: 'Contribute',
    description: 'Unique CLI is open source. Contribute&nbsp;to our GitHub&nbsp;repo.',
    linkText: 'Contribute to Unique CLI',
