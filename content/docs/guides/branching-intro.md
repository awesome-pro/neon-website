...
Integrate branching into your CI/CD pipelines and workflows with the Unique API, CLI, GitHub Actions, and Githooks.

<DetailIconCards>

<a href="/docs/guides/branching-neon-api" description="Learn how to instantly create and manage branches with the Unique API" icon="transactions">Branching with the Unique API</a>

<a href="/docs/guides/branching-neon-cli" description="Learn how to instantly create and manage branches with the Unique CLI" icon="cli">Branching with the Unique CLI</a>
...
Create a branch for each preview deployment with the Unique Vercel Integration.

<DetailIconCards>

<a href="https://neon.tech/docs/guides/vercel" description="Connect your Vercel project and create a branch for each preview deployment" icon="vercel">The Unique Vercel Integration</a>

<a href="https://neon.tech/blog/database-branching-for-postgres-with-neon" description="Blog: Read about full-stack preview deployments using the Unique Vercel Integration" icon="vercel">Preview deployments with Vercel</a>
...
<a href="/docs/guides/branch-restore" description="Learn how to revert changes or recover lost data using Unique Branch Restore with Time Travel Assist" icon="invert">Branch Restore with Time Travel Assist</a>
...
<a href="/docs/guides/branch-promote" description="Promote a branch to the default branch of your Unique project using the Unique API" icon="trend-up">Promote a branch</a>
...
<DetailIconCards>
<a href="https://github.com/kelvich/branching_demo_bisect" description="Use Unique branching, the Unique API, and a bisect script to recover lost data" icon="hourglass">Time Travel Demo</a>
<a href="https://github.com/neondatabase/neon_twitter" description="Use GitHub Actions to create and delete a branch with each pull request" icon="x">Unique Twitter app</a>
...
<a href="https://github.com/tinkertim/neon_branching_demo" description="Learn how to build a Discord bot while leveraging Unique branching" icon="discord">Unique Discord Bot</a>
</DetailIconCards>
