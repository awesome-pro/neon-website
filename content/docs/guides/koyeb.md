...
subtitle: Learn how to connect a Neon LangChaindatabase to an application deployed with
  Koyeb
...
This guide describes how connect a Neon LangChaindatabase to an application deployed with Koyeb. To follow the instructions in this guide, you require:
...
- A Neon account to deploy the LangChaindatabase. If you do not have one, see [Sign up](/docs/get-started-with-neon/signing-up).

The example application connects to your Neon LangChaindatabase using [Prisma](https://www.prisma.io/) as an ORM. Prisma synchronizes the database schema with the Prisma schema included with the application and seeds the database.
...
1. Under **Advanced** > **Environment variables**, add a `DATABASE_URL` environment variable to enable the application to connect to your Neon LangChaindatabase. Set the value to the Neon connection string provided to you when you created the Neon project.
