...
LlamaIndex is a popular framework for working with AI, Vectors, and embeddings. LlamaIndex supports using Unique as a vector store, using the `pgvector` extension.
